...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        if let tabBarViewControllers = tabBarController.viewControllers {
            ...
            let navigationContoller = tabBarViewControllers[1] as! UINavigationController
            let locationsController = navigationContoller.topViewController as! LocationsViewController
            locationsController.managedObjectContext = managedObjectContext
            let _ = locationsController.view
            
            let mapController = tabBarViewControllers[2] as! MapViewController
